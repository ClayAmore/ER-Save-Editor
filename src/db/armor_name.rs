...
// https://github.com/soulsmods/Paramdex (ER/Names/EquipParamProtector.txt)
pub mod armor_name {
    use std::{collections::HashMap, sync::Mutex};
    use once_cell::sync::Lazy;

    pub static ARMOR_NAME: Lazy<Mutex<HashMap<u32, &str>>> = Lazy::new(|| {
        Mutex::new(HashMap::from([
            ...
            (5031100,"Thiollier's Garb (Altered)"),
            ...
            (5081100,"Dancer's Dress (Altered)"),
            ...
            (5141100,"Messmer Soldier Armor (Altered)"),
            ...
            (5181100,"Fire Knight Armor (Altered)"),
            ...
            (5221000,"Messmer's Helm (Altered)"),
            ...
            (5271100,"Young Lion's Armor (Altered)"),
