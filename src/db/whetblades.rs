pub mod whetblades {
    ...
    pub static WHETBLADES: Lazy<Mutex<HashMap<Whetblade, (u32, &str)>>> = Lazy::new(|| {
        Mutex::new(HashMap::from([
            ...
            (
                Whetblade::BlackWhetbladeBlood,
                (65710, "Black Whetblade (Blood)"),
            ),
            (
                Whetblade::BlackWhetbladeOccult,
                (65720, "Black Whetblade (Occult)"),
            ),
            (
                Whetblade::BlackWhetbladePoison,
                (65700, "Black Whetblade (Poison)"),
            ),
            (
                Whetblade::GlintstoneWhetbladeFrost,
                (65690, "Glintstone Whetblade (Frost)"),
            ),
            (
                Whetblade::GlintstoneWhetbladeMagic,
                (65680, "Glintstone Whetblade (Magic)"),
            ),
            (
                Whetblade::IronWhetbladeHeavy,
                (65610, "Iron Whetblade (Heavy)"),
            ),
            (
                Whetblade::IronWhetbladeKeen,
                (65620, "Iron Whetblade (Keen)"),
            ),
            (
                Whetblade::IronWhetbladeQuality,
            ...
            (
                Whetblade::RedHotWhetbladeFlameArt,
                (65650, "Red-Hot Whetblade (Flame Art)"),
            ),
            (
                Whetblade::SanctifiedWhetbladeLightning,
                (65660, "Sanctified Whetblade (Lightning)"),
            ),
            (
                Whetblade::SanctifiedWhetbladeSacred,
