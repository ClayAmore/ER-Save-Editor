...
pub fn weapons() -> &'static BTreeMap<String, Vec<u32>> {
    ...
    WEAPONS.get_or_init(|| {
        ...
        weapon_groups.insert(
            "Heavy Thrusting Swords".to_string(),
            vec![
