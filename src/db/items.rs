...
pub fn items() -> &'static BTreeMap<String, Vec<u32>> {
    ...
    ITEMS.get_or_init(|| {
        ...
        item_groups.insert(
            "Somber Smithing Stone".to_string(),
            vec![
