...
pub fn armor_sets() -> &'static BTreeMap<String, Vec<u32>> {
    ...
    ARMORS.get_or_init(|| {
        ...
        armor_sets.insert(
            "Nox Swordstress Crown".to_string(),
            vec![
        ...
        armor_sets.insert(
            "Queen of the Full Moon".to_string(),
            vec![
        ...
        armor_sets.insert(
            "Envoy Crown".to_string(),
            vec![
                0x100C8320, // Envoy Crown
            ],
        );
        armor_sets.insert(
            "Raya Lucarian Sorcerer".to_string(),
            vec![
        ...
        armor_sets.insert(
            "Hierodas Glintstone Crown".to_string(),
            vec![
        ...
        armor_sets.insert(
            "Raya Lucarian Soldier".to_string(),
            vec![
        ...
        armor_sets.insert(
            "Godrick Foot Soldier".to_string(),
            vec![
        ...
        armor_sets.insert(
            "Leyndell Foot Soldier".to_string(),
            vec![
        ...
        armor_sets.insert(
            "Mausoleum Foot Soldier".to_string(),
            vec![
        ...
        armor_sets.insert(
            "Haligtree Foot Soldier".to_string(),
            vec![
