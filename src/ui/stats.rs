        ...
        egui::Frame::default().show(ui, |ui| {
            ui.with_layout(egui::Layout::top_down_justified(egui::Align::Min), |ui| {
                ui.with_layout(egui::Layout::top_down(egui::Align::Min), |ui| {
                    ...
                    let class =
                        &STARTER_CLASSES.lock().unwrap()[&vm.slots[vm.index].stats_vm.arche_type];

                    // Calculate level from stats
                    let level = vm.slots[vm.index].stats_vm.vigor
                    ...
                    table.body(|mut body| {
                        ...
                        self::stat_field(
                            ...
                            class.vigor..=99,
                            "Vigor:",
                            &mut vm.slots[vm.index].stats_vm.vigor,
                        );
                        self::stat_field(
                            &mut body,
                            class.mind..=99,
                            "Mind:",
                            &mut vm.slots[vm.index].stats_vm.mind,
                        );
                        self::stat_field(
                            &mut body,
                            class.endurance..=99,
                            "Endurance:",
                            &mut vm.slots[vm.index].stats_vm.endurance,
                        );
                        self::stat_field(
                            &mut body,
                            class.strength..=99,
                            "Strength:",
                            &mut vm.slots[vm.index].stats_vm.strength,
                        );
                        self::stat_field(
                            &mut body,
                            class.dexterity..=99,
                            "Dexterity:",
                            &mut vm.slots[vm.index].stats_vm.dexterity,
                        );
                        self::stat_field(
                            &mut body,
                        ...
                        self::stat_field(
                            ...
                            class.faith..=99,
                            "Faith:",
                            &mut vm.slots[vm.index].stats_vm.faith,
                        );
                        self::stat_field(
                            &mut body,
                            class.arcane..=99,
                            "Arcane:",
                            &mut vm.slots[vm.index].stats_vm.arcane,
                        );
                        ...
                        // Souls
                        let field =
                            egui::widgets::DragValue::new(&mut vm.slots[vm.index].stats_vm.souls)
