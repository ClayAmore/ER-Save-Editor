...
pub mod equipment {
    ...
    fn combo_box(ui: &mut Ui, vm: &mut ViewModel, index: usize, r#type: InventorySubTypeRoute) {
        ...
        ui.allocate_ui_with_layout(
            Vec2::new(EQUIPMENT_BOX_WIDTH, ui.available_height()),
                ...
                ui.group(|ui| {
                    ...
                    ui.label(match r#type {
                        ...
                        InventorySubTypeRoute::WeaponLeft => {
                            egui::RichText::new(format!("WeaponLeft{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::WeaponRight => {
                            egui::RichText::new(format!("WeaponRight{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::Head => {
                            egui::RichText::new(format!("Head{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::Body => {
                            egui::RichText::new(format!("Body{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::Arms => {
                            egui::RichText::new(format!("Arms{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::Legs => {
                            egui::RichText::new(format!("Legs{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::Arrow => {
                            egui::RichText::new(format!("Arrow{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::Bolt => {
                            egui::RichText::new(format!("Bolt{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::Talisman => {
                            egui::RichText::new(format!("Talisman{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::QuickItem => {
                            egui::RichText::new(format!("Quickitem{}", index + 1)).strong()
                        }
                        InventorySubTypeRoute::Pouch => {
                            egui::RichText::new(format!("Pouch{}", index + 1)).strong()
                        }
                    });
                    ui.separator();
                    ui.label(&format!(
                        ...
                        match r#type {
                            ...
                            InventorySubTypeRoute::WeaponLeft =>
                                &equipment_vm.left_hand_armaments[index].name,
                            InventorySubTypeRoute::WeaponRight =>
                                &equipment_vm.right_hand_armaments[index].name,
                            ...
                            InventorySubTypeRoute::QuickItem =>
                                &equipment_vm.quickitems[index].name,
                    ...
                    if ui.button("Change").clicked() {
                        ...
                        equipment_vm.current_equipped_items =
                            match &inventory_vm.current_subtype_route {
                                ...
                                InventorySubTypeRoute::Head => {
                                    vec![equipment_vm.head.equip_index]
                                }
                                InventorySubTypeRoute::Body => {
                                    vec![equipment_vm.arms.equip_index]
                                }
                                InventorySubTypeRoute::Arms => {
                                    vec![equipment_vm.chest.equip_index]
                                }
                                InventorySubTypeRoute::Legs => {
                                    vec![equipment_vm.legs.equip_index]
                                }
                                InventorySubTypeRoute::Arrow => Vec::from_iter(
                                    equipment_vm.arrows.iter().map(|i| i.equip_index),
                                ),
                                InventorySubTypeRoute::Bolt => {
                                    Vec::from_iter(equipment_vm.bolts.iter().map(|i| i.equip_index))
                                }
                                InventorySubTypeRoute::Talisman => Vec::from_iter(
                                    equipment_vm.talismans.iter().map(|i| i.equip_index),
                                ),
                                InventorySubTypeRoute::QuickItem | InventorySubTypeRoute::Pouch => {
                                    let mut items = Vec::from_iter(
                                        equipment_vm.quickitems.iter().map(|i| i.equip_index),
                                    );
    ...
    fn side_panel(ui: &mut Ui, vm: &mut ViewModel) {
        ...
        match inventory_vm.current_subtype_route {
            ...
            InventorySubTypeRoute::Head => {
                ui.vertical_centered_justified(|ui| {
                    ui.heading(
                        egui::RichText::new(format!("Head{}", equipment_vm.current_index + 1))
                            .strong(),
                    );
                });
            }
            InventorySubTypeRoute::Body => {
                ui.vertical_centered_justified(|ui| {
                    ui.heading(
                        egui::RichText::new(format!("Body{}", equipment_vm.current_index + 1))
                            .strong(),
                    );
                });
            }
            InventorySubTypeRoute::Arms => {
                ui.vertical_centered_justified(|ui| {
                    ui.heading(
                        egui::RichText::new(format!("Arms{}", equipment_vm.current_index + 1))
                            .strong(),
                    );
                });
            }
            InventorySubTypeRoute::Legs => {
                ui.vertical_centered_justified(|ui| {
                    ui.heading(
                        egui::RichText::new(format!("Legs{}", equipment_vm.current_index + 1))
                            .strong(),
                    );
                });
            }
            InventorySubTypeRoute::Arrow => {
                ui.vertical_centered_justified(|ui| {
                    ui.heading(
                        egui::RichText::new(format!("Arrow{}", equipment_vm.current_index + 1))
                            .strong(),
                    );
                });
            }
            InventorySubTypeRoute::Bolt => {
                ui.vertical_centered_justified(|ui| {
                    ui.heading(
                        egui::RichText::new(format!("Bolt{}", equipment_vm.current_index + 1))
                            .strong(),
                    );
                });
            }
            InventorySubTypeRoute::Talisman => {
                ui.vertical_centered_justified(|ui| {
                    ui.heading(
                        egui::RichText::new(format!("Talisman{}", equipment_vm.current_index + 1))
                            .strong(),
                    );
                });
            }
            InventorySubTypeRoute::QuickItem => {
                ui.vertical_centered_justified(|ui| {
                    ui.heading(
                        egui::RichText::new(format!("Quickitem{}", equipment_vm.current_index + 1))
                            .strong(),
                    );
                });
            }
            InventorySubTypeRoute::Pouch => {
                ui.vertical_centered_justified(|ui| {
                    ui.heading(
                        egui::RichText::new(format!("Pouch{}", equipment_vm.current_index + 1))
                            .strong(),
                    );
                });
            }
        ...
        let current_inventory_list = match &inventory_vm.current_subtype_route {
            ...
            InventorySubTypeRoute::QuickItem | InventorySubTypeRoute::Pouch => {
                &inventory_vm.storage[0].filtered_items
            }
        };
        if current_inventory_list.is_empty() {
            ...
            egui::ScrollArea::vertical().auto_shrink(false).show_rows(
                ui,
                10.,
                current_inventory_list.len(),
                |ui, row_range| {
                    egui::Grid::new("availbale_equipment_list")
                        .striped(true)
                        .show(ui, |ui| {
                            for i in row_range {
                                let item = &current_inventory_list[i];
                                if item.item_id == inventory_vm.unarmed.item_id {
                                    continue;
                                } // Skip showing "unarmed" weapon which is the weapon used when weapon slot is empty.
                                let item_name_ui = egui::RichText::new(item.item_name.to_string());
                                let is_current_item = item.equip_index
                                    == match &inventory_vm.current_subtype_route {
                                        InventorySubTypeRoute::None => 0,
                                        InventorySubTypeRoute::WeaponLeft => {
                                            equipment_vm.left_hand_armaments
                                                [equipment_vm.current_index]
                                                .equip_index
                                        }
                                        InventorySubTypeRoute::WeaponRight => {
                                        ...
                                        InventorySubTypeRoute::Arrow => {
                                            equipment_vm.arrows[equipment_vm.current_index]
                                                .equip_index
                                        }
                                        InventorySubTypeRoute::Bolt => {
                                            equipment_vm.bolts[equipment_vm.current_index]
                                                .equip_index
                                        }
                                        InventorySubTypeRoute::Talisman => {
                                            equipment_vm.talismans[equipment_vm.current_index]
                                                .equip_index
                                        }
                                        InventorySubTypeRoute::QuickItem => {
                                            equipment_vm.quickitems[equipment_vm.current_index]
                                                .equip_index
                                        }
                                        InventorySubTypeRoute::Pouch => {
                                            equipment_vm.pouch[equipment_vm.current_index]
                                                .equip_index
                                        }
                                    };
                                equipment_vm.quickitems[equipment_vm.current_index].equip_index;
                                let is_equipped_item = equipment_vm
                                    .current_equipped_items
                                    .iter()
                                    .any(|id| *id == item.equip_index);
                                ui.label(if is_current_item {
                                    item_name_ui
                                } else {
                                    item_name_ui
                                });
                                if is_current_item {
                                    if inventory_vm.current_subtype_route
                                        == InventorySubTypeRoute::Head
                                        && inventory_vm.naked_head.ga_item_handle == 0
                                    {
                                        ui.label("Equipped");
                                    } else if inventory_vm.current_subtype_route
                                        == InventorySubTypeRoute::Body
                                        && inventory_vm.naked_head.ga_item_handle == 0
                                    {
                                        ui.label("Equipped");
                                        ...
                                        && inventory_vm.naked_head.ga_item_handle == 0
                                    {
                                        ...
                                        .add_sized(
                                            [100., 24.],
                                            egui::Button::new("Unequip").fill(Color32::LIGHT_RED),
                                        )
                                        .clicked()
                                    {
                                        ...
                                        match &inventory_vm.current_subtype_route {
                                            InventorySubTypeRoute::None => {}
                                            InventorySubTypeRoute::WeaponLeft => {
                                                let pos = equipment_vm
                                                    .current_equipped_items
                                                    .iter()
                                                    .position(|id| {
                                                        *id == equipment_vm.left_hand_armaments
                                                            [equipment_vm.current_index]
                                                            .equip_index
                                                    })
                                                    .unwrap();
                                                equipment_vm.left_hand_armaments
                                                    [equipment_vm.current_index]
                                                    .gaitem_handle =
                                                    inventory_vm.unarmed.ga_item_handle;
                                                equipment_vm.left_hand_armaments
                                                    [equipment_vm.current_index]
                                                    .id = inventory_vm.unarmed.item_id;
                                                equipment_vm.left_hand_armaments
                                                    [equipment_vm.current_index]
                                                    .equip_index = inventory_vm.unarmed.equip_index;
                                                equipment_vm.left_hand_armaments
                                                    [equipment_vm.current_index]
                                            ...
                                            InventorySubTypeRoute::WeaponRight => {
                                                let pos = equipment_vm
                                                    ...
                                                    .iter()
                                                    .position(|id| {
                                                        *id == equipment_vm.right_hand_armaments
                                                            [equipment_vm.current_index]
                                                            .equip_index
                                                    })
                                                    .unwrap();
                                            ...
                                            InventorySubTypeRoute::Head => {
                                                if inventory_vm.naked_head.ga_item_handle != 0 {
                                                    equipment_vm.head.gaitem_handle =
                                                        inventory_vm.naked_head.ga_item_handle;
                                                    equipment_vm.head.id =
                                                        inventory_vm.naked_head.item_id;
                                                    equipment_vm.head.equip_index =
                                                        inventory_vm.naked_head.equip_index;
                                            ...
                                            InventorySubTypeRoute::Body => {
                                                if inventory_vm.naked_body.ga_item_handle != 0 {
                                                    equipment_vm.chest.gaitem_handle =
                                                        inventory_vm.naked_body.ga_item_handle;
                                                    equipment_vm.chest.id =
                                                        inventory_vm.naked_body.item_id;
                                                    equipment_vm.chest.equip_index =
                                                        inventory_vm.naked_body.equip_index;
                                            ...
                                            InventorySubTypeRoute::Arms => {
                                                if inventory_vm.naked_arms.ga_item_handle != 0 {
                                                    equipment_vm.arms.gaitem_handle =
                                                        inventory_vm.naked_arms.ga_item_handle;
                                                    equipment_vm.arms.id =
                                                        inventory_vm.naked_arms.item_id;
                                                    equipment_vm.arms.equip_index =
                                                        inventory_vm.naked_arms.equip_index;
                                            ...
                                            InventorySubTypeRoute::Legs => {
                                                if inventory_vm.naked_legs.ga_item_handle != 0 {
                                                    equipment_vm.legs.gaitem_handle =
                                                        inventory_vm.naked_legs.ga_item_handle;
                                                    equipment_vm.legs.id =
                                                        inventory_vm.naked_legs.item_id;
                                                    equipment_vm.legs.equip_index =
                                                        inventory_vm.naked_legs.equip_index;
                                            ...
                                            InventorySubTypeRoute::Bolt => {
                                                ...
                                                equipment_vm.bolts[equipment_vm.current_index]
                                                    .gaitem_handle = 0;
                                                equipment_vm.bolts[equipment_vm.current_index].id =
                                                    0;
                                                equipment_vm.bolts[equipment_vm.current_index]
                                                    .equip_index = 0;
                                                equipment_vm.bolts[equipment_vm.current_index]
                                            ...
                                            InventorySubTypeRoute::Pouch => {
                                                ...
                                                equipment_vm.pouch[equipment_vm.current_index]
                                                    .gaitem_handle = 0;
                                                equipment_vm.pouch[equipment_vm.current_index].id =
                                                    0;
                                                equipment_vm.pouch[equipment_vm.current_index]
                                                    .equip_index = 0;
                                                equipment_vm.pouch[equipment_vm.current_index]
                                    ...
                                    if ui
                                        .add_sized([100., 24.], egui::Button::new("Equip"))
                                        .clicked()
                                    {
                                        // Mark this section as changed so when the file is
                                        // saved then it will write this section to the file
                                        ...
                                        match &inventory_vm.current_subtype_route {
                                            ...
                                            InventorySubTypeRoute::WeaponLeft => {
                                                ...
                                                equipment_vm.left_hand_armaments
                                                    [equipment_vm.current_index]
                                                    .gaitem_handle = item.ga_item_handle;
                                                equipment_vm.left_hand_armaments
                                                    [equipment_vm.current_index]
                                                    .id = item.item_id;
                                                equipment_vm.left_hand_armaments
                                                ...
                                                equipment_vm.current_equipped_items[pos] =
                                                    item.equip_index;
                                            }
                                            InventorySubTypeRoute::WeaponRight => {
                                                let pos = equipment_vm
                                            ...
                                            InventorySubTypeRoute::Head => {
                                                ...
                                                equipment_vm.current_equipped_items[0] =
                                                    item.equip_index;
                                            }
                                            InventorySubTypeRoute::Body => {
                                                equipment_vm.chest.gaitem_handle =
