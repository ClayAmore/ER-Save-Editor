pub mod params {
    ...
    impl FromStr for Param {
        ...
        fn from_str(s: &str) -> Result<Self, Self::Err> {
            match s {
                ...
                "LegacyDistantViewPartsReplaceParam" => {
                    Ok(Self::LegacyDistantViewPartsReplaceParam)
                }
                "LoadBalancerDrawDistScaleParam" => Ok(Self::LoadBalancerDrawDistScaleParam),
                "LoadBalancerDrawDistScaleParam_ps4" => {
                    Ok(Self::LoadBalancerDrawDistScaleParam_ps4)
                }
                "LoadBalancerDrawDistScaleParam_ps5" => {
                    Ok(Self::LoadBalancerDrawDistScaleParam_ps5)
                }
                "LoadBalancerDrawDistScaleParam_xb1" => {
                    Ok(Self::LoadBalancerDrawDistScaleParam_xb1)
                }
                "LoadBalancerDrawDistScaleParam_xb1x" => {
                    Ok(Self::LoadBalancerDrawDistScaleParam_xb1x)
                }
                "LoadBalancerDrawDistScaleParam_xss" => {
                    Ok(Self::LoadBalancerDrawDistScaleParam_xss)
                }
                "LoadBalancerDrawDistScaleParam_xsx" => {
                    Ok(Self::LoadBalancerDrawDistScaleParam_xsx)
                }
                "LoadBalancerNewDrawDistScaleParam_ps4" => {
                    Ok(Self::LoadBalancerNewDrawDistScaleParam_ps4)
                }
                "LoadBalancerNewDrawDistScaleParam_ps5" => {
                    Ok(Self::LoadBalancerNewDrawDistScaleParam_ps5)
                }
                "LoadBalancerNewDrawDistScaleParam_win64" => {
                    Ok(Self::LoadBalancerNewDrawDistScaleParam_win64)
                }
                "LoadBalancerNewDrawDistScaleParam_xb1" => {
                    Ok(Self::LoadBalancerNewDrawDistScaleParam_xb1)
                }
                "LoadBalancerNewDrawDistScaleParam_xb1x" => {
                    Ok(Self::LoadBalancerNewDrawDistScaleParam_xb1x)
                }
                "LoadBalancerNewDrawDistScaleParam_xss" => {
                    Ok(Self::LoadBalancerNewDrawDistScaleParam_xss)
                }
                "LoadBalancerNewDrawDistScaleParam_xsx" => {
                    Ok(Self::LoadBalancerNewDrawDistScaleParam_xsx)
                }
                ...
                "SoundAutoReverbEvaluationDistParam" => {
                    Ok(Self::SoundAutoReverbEvaluationDistParam)
                }
                ...
                "WwiseValueToStrParam_BgmBossChrIdConv" => {
                    Ok(Self::WwiseValueToStrParam_BgmBossChrIdConv)
                }
                "WwiseValueToStrParam_EnvPlaceType" => Ok(Self::WwiseValueToStrParam_EnvPlaceType),
                "WwiseValueToStrParam_Switch_AttackStrength" => {
                    Ok(Self::WwiseValueToStrParam_Switch_AttackStrength)
                }
                "WwiseValueToStrParam_Switch_AttackType" => {
                    Ok(Self::WwiseValueToStrParam_Switch_AttackType)
                }
                "WwiseValueToStrParam_Switch_DamageAmount" => {
                    Ok(Self::WwiseValueToStrParam_Switch_DamageAmount)
                }
                "WwiseValueToStrParam_Switch_DeffensiveMaterial" => {
                    Ok(Self::WwiseValueToStrParam_Switch_DeffensiveMaterial)
                }
                "WwiseValueToStrParam_Switch_GrassHitType" => {
                    Ok(Self::WwiseValueToStrParam_Switch_GrassHitType)
                }
                "WwiseValueToStrParam_Switch_HitStop" => {
                    Ok(Self::WwiseValueToStrParam_Switch_HitStop)
                }
                "WwiseValueToStrParam_Switch_OffensiveMaterial" => {
                    Ok(Self::WwiseValueToStrParam_Switch_OffensiveMaterial)
                }
                "WwiseValueToStrParam_Switch_PlayerEquipmentBottoms" => {
                    Ok(Self::WwiseValueToStrParam_Switch_PlayerEquipmentBottoms)
                }
                "WwiseValueToStrParam_Switch_PlayerEquipmentTops" => {
                    Ok(Self::WwiseValueToStrParam_Switch_PlayerEquipmentTops)
                }
                "WwiseValueToStrParam_Switch_PlayerShoes" => {
                    Ok(Self::WwiseValueToStrParam_Switch_PlayerShoes)
                }
                "WwiseValueToStrParam_Switch_PlayerVoiceType" => {
                    Ok(Self::WwiseValueToStrParam_Switch_PlayerVoiceType)
                }
                _ => Err(std::io::Error::new(
                    std::io::ErrorKind::InvalidData,
                    format!("Cannot recognize paramtype: {}", s),
                )),
            }
        }
    }
        ...
        T: Default + Clone,
    {
        ...
        pub fn read(br: &mut BinaryReader) -> Result<Self, std::io::Error> {
            ...
            br.set_endian(if param.big_endian {
                Endian::Big
            } else {
                Endian::Little
            });
            ...
            if ((param.format2d & FormatFlags1::Flag01).as_u8() != 0)
                && ((param.format2d & FormatFlags1::IntDataOffset).as_u8() != 0)
                || ((param.format2d & FormatFlags1::LongDataOffset).as_u8() != 0)
            {
            ...
            for _i in 0..row_count {
                param
                    .rows
                    .push(Row::read(br, &param, &mut actual_string_offset)?);
            }

            if param.rows.len() > 1 {
                param.detected_size = param.rows[1].data_offset - param.rows[0].data_offset;
            } else if param.rows.len() == 1 {
                param.detected_size = (if actual_string_offset == 0 {
                    string_offset as i64
                } else {
                    actual_string_offset
                }) - param.rows[0].data_offset;
            } else {
