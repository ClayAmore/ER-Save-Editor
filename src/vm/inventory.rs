pub mod inventory {
    ...
    use crate::{db::{accessory_name::weapon_name::ACCESSORY_NAME, aow_name::weapon_name::AOW_NAME, armor_name::weapon_name::ARMOR_NAME, item_name::item_name::ITEM_NAME, weapon_name::weapon_name::WEAPON_NAME}, save::save_slot::{EquipInventoryData, EquipInventoryItem, GaItem, SaveSlot}};
