pub mod slot_view_model {
    use crate::{
        ...
        vm::{
            ...
            general::general_view_model::GeneralViewModel, inventory::InventoryViewModel,
            regions::regions_view_model::RegionsViewModel, stats::stats_view_model::StatsViewModel,
        },
    };
